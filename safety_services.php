...
<html lang="en">
    ...
    <div class="mission-vision-container">
        <div class="our-mission">
            <h1>Safety and Health Services</h1>
            <hr class="line">
            <p>The Safety and Health Services is a provider of first aid training, ensuring the health and safety of the students in the Pamantasan ng Lungsod ng Valenzuela. It aims to ensure that public health emergencies are responded quickly. This services emphasize the importance of diseases prevention, safety and health promotion</p>
        </div>
        <div class="mission-image">
            <img src="./assets/images/safety_service.jpg" alt="safety_services">
        </div>
    </div>
