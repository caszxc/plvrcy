...
<html lang="en">
    <head>
        ...
        <title>Red cross Youth - Safety and health Services</title>
    ...
    <h1>Disaster Management Services</h1>
                <hr class="line">
                <p>Disaster Management Services is responsible in terms of management and risk education. It is also part of the emergency and evacuation team of the Pamantasan ng Lungsod ng Valenzuela for emergency drills. Additionally, this services focuses on the implementing preparedness and taking preventive measures that helps ensure safety in times of disasters and calamities.</p>
            </div>
            <div class="mission-image">
                <img src="" alt="Disaster Management Services">
            </div>
        </div>
