...
<html lang="en">
    <head>
        ...
        <title>Red Cross Youth - Mission</title>
    ...
    <div class="mission-vision-container">
        <div class="our-mission">
            <h1>Our Mission</h1>
            <hr class="line">
<p>Our Mission is to serve as a dynamic and proactive organization that 
    provides opportunities for young people to contribute to humanitarian
     work, while promoting volunteerism, responsibility, and leadership.
      It aims to engage and empower youth to take part in disaster response, 
      preparedness, health and welfare programs, and community service, embodying the spirit of volunteerism and compassion.
</p>
        </div>
        <div class="mission-image">
            <img src="./assets/images/mission.png" alt="Our Mission Image">
        </div>
    </div>
